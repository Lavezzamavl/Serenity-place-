...
class TestRequestViewSet(AuditLoggingMixin, viewsets.ModelViewSet):
    ...
    def approve(self, request, pk=None):
        ...
        log_action(request, AuditLog.Action.UPDATE, test, changes={'status': ['Resulted', 'Approved']})
    ...
    def collect(self, request, pk=None):
        ...
        log_action(request, AuditLog.Action.UPDATE, test, changes={'status': ['Requested', 'Collected']})
        return Response(TestRequestSerializer(test).data)
    ...
    def submit_result(self, request, pk=None):
        ...
        log_action(request, AuditLog.Action.UPDATE, test, changes={'status': ['Collected', 'Resulted']})
        return Response(TestRequestSerializer(test).data)
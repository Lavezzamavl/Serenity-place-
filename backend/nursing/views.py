...
class NursingNoteViewSet(AuditLoggingMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(self.request, AuditLog.Action.CREATE, module='nursing', detail=str(note))
...
class VitalsCheckViewSet(AuditLoggingMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(self.request, AuditLog.Action.CREATE, module='nursing', detail=str(vitals))
...
class MedicationAdministrationViewSet(AuditLoggingMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(self.request, AuditLog.Action.CREATE, module='nursing', detail=str(entry))
...
class ConsumableUsageViewSet(AuditLoggingMixin, viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        log_action(self.request, AuditLog.Action.CREATE, module='nursing', detail=str(usage))
